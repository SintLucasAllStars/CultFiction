...
public class GameObjectIntDictionaryDrawer : SerializableDictionaryDrawer<GameObject, int>
{
    ...
    {
        return GetGenericTemplate<SerializableGameObjectIntTemplate>();
    }
}
internal class SerializableGameObjectIntTemplate : SerializableKeyValueTemplate<GameObject, int> { }
